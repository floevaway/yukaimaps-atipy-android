 ...
 */
/*
 * Extends OsmConnection without OAuth danse
 */
public class OsmOIDCConnection extends OsmConnection
{
	...
	*/
	 ...
	 */
	public OsmOIDCConnection(String apiUrl, String userAgent, Integer timeout)
	{
		super(apiUrl, userAgent, null, timeout);
		this.apiUrl = apiUrl;
	...
	/**
	 * @see #OsmOIDCConnection(String, String, Integer)
	 */
	public OsmOIDCConnection(String apiUrl, String userAgent)
	{
		this(apiUrl, userAgent, null);
	}
	...
	{
		System.out.print("getOAuth");
		// try to fool API doing things like
		// bool authenticated = osm.getOAuth() != null;
	...
	*/
		...
		if(authenticate)
		{
			if (this.accessToken == null)
			{
				throw new OAuthExpectationFailedException(
						"This OIDC class has no token. Only API calls " +
	...
	{
		throw new OAuthExpectationFailedException(
				"This OIDC class has been initialized without a OAuthConsumer. Only API calls " +
				"that do not require authentication can be made.");
		/*
